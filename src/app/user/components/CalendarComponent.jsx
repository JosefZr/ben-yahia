...
import { createReservation, getAppointmentsByDate } from '../api/appointment';
...
export default function CalendarComponent({ days = [], closeDays = [], onCloseModal }) {
    ...
    const handleCreateReservation = () => {
        ...
        if (justDate && time) {
            ...
            mutation.mutate({ date: formattedDate, time, userId: parseInt(userId), note });
        }
    };
    ...
    return (
        <div className='flex flex-col justify-center items-center'>
            ...
            {date.justDate && availableTimes && availableTimes.length > 0 && (
